...
\caption{\textbf{Sensitivity of DynaTree to drafting hyperparameters (WikiText-2, \(T=1500\)).} Left: throughput distribution across sweep categories (threshold, branch, depth, and cross-combinations); dashed line indicates the autoregressive throughput measured in the same sweep run. Right: throughput--acceptance tradeoff across all configurations.}
